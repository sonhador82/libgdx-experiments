...
//        draw_bezier(g2d, items);
    ...
    private void draw_cutmull(Graphics2D g2d, Vector2[] points) {
        ...
        for (int i = 0; i < 1000; i++){
            float cur_pos = (float) (i*0.001);
            CatmullRomSpline.calculate(out_vect, cur_pos, points, false, tmp_vect);
